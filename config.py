...
def get_args():
    ...
    argp.add_argument('--agent', type = str, default = "mcts")
    argp.add_argument('--cli', action = 'store_true')
    argp.add_argument('--rows', type = int, default = 15)
    argp.add_argument('--cols', type = int, default = 15)
    argp.add_argument('--cnt', type = int, default = 5)
